...
public class PushableCrate : MonoBehaviour, ILevelTemporaryState, IPushMover
{
    ...
    public bool IsAttached(PlayerActor actor) { return actor != null && (actor == human || actor == dog); }
    ...
    void UpdatePushAudio(bool moving)
    {
        ...
        if (moving)
        {
            ...
            {
                Debug.LogWarning("[PushableCrate] Play_Crate_Push is not assigned.", this);
    ...
    void StopPushAudioImmediate()
    {
        ...
        else
        {
            ...
            {
                Debug.LogWarning("[PushableCrate] Stop_Crate_Push is not assigned; stopped the loop without its release tail.", this);
    ...
    int FindMatchingPoint(PlayerActor actor)
    {
        int best = -1;
    ...
    void IgnoreCrateCollision(PlayerActor actor, bool ignore)
    {
