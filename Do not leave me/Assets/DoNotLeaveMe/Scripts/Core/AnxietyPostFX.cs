...
/// </summary>
[AddComponentMenu("DoNotLeaveMe/Anxiety Post FX")]
public class AnxietyPostFX : MonoBehaviour
{
    ...
    public float GetAnxiety01()
    {
        ...
        // 正式关卡优先：AnxietyState 是正式关的焦虑数据源
        if (AnxietyState.Instance != null) return Mathf.Clamp01(AnxietyState.Instance.Normalized);
