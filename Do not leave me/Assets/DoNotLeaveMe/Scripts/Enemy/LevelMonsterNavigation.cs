...
public class LevelMonsterNavigation : MonoBehaviour
{
    ...
    private readonly List<Door> trackedDoors = new List<Door>();
    private readonly Dictionary<Door, Bounds> trackedDoorBounds = new Dictionary<Door, Bounds>();
    ...
    void OnDestroy()
    {
        foreach (Door door in trackedDoors)
            if (door != null)
    ...
    void OnTrackedDoorStateChanged(Door door)
    {
