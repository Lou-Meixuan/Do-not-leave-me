...
public static class BreadManUIBuilder
{
    ...
    // ---------- 美术资源路径 ----------
    const string P_PAUSE_PANEL   = "Assets/Art/UI/03_Pause/pause-menu-empty-panel-transparent (1).png";
    const string P_BTN_CONTINUE  = "Assets/Art/UI/03_Pause/button_continue_standard.png";
    const string P_BTN_SETTINGS  = "Assets/Art/UI/03_Pause/button_settings_standard.png";
    const string P_BTN_RESTART   = "Assets/Art/UI/03_Pause/button_restart_standard.png";
    const string P_BTN_MAINMENU  = "Assets/Art/UI/03_Pause/button_main_menu_standard.png";
    const string P_HUD_SETTINGS  = "Assets/Art/UI/01_StartMenu/ui_settings.png";
    const string P_WHITE         = "Assets/DoNotLeaveMe/UI/Tex_White.png";

    const string P_UI_SYSTEM_PREFAB     = "Assets/DoNotLeaveMe/Prefabs/UI_System.prefab";
    const string P_SETTINGS_PANEL_PREFAB = "Assets/DoNotLeaveMe/Prefabs/SettingsPanel.prefab";

    // ---------- 场景流程 ----------
    const string S_START    = "Assets/DoNotLeaveMe/Levels/Start.unity";
    const string S_CUTSCENE = "Assets/DoNotLeaveMe/Levels/Cutscene_Intro.unity";
    const string S_LEVEL    = "Assets/DoNotLeaveMe/Levels/Level_01.unity";
    const string S_END      = "Assets/DoNotLeaveMe/Levels/Cutscene_End.unity";
    const string LEVEL_SCENE_NAME = "Level_01";
    ...
    public static void BuildFramework()
    {
        ...
        if (canvas == null)
        {
            EditorUtility.DisplayDialog("搭建失败", "场景里没有 Canvas，也找不到 UI_System.prefab。请先把 Assets/DoNotLeaveMe/Prefabs/UI_System.prefab 拖进场景。", "知道了");
            return;
        }
        EnsureEventSystem();
    ...
    public static void SetupSceneFlow()
    {
        ...
        string msg = "[面包人UI] 场景流程配好了。\n"
            ...
            + "\n还剩两件事要你手动做（都是几次点击）：\n"
            + "1. 把做好的视频文件拖进 Assets 里（建议放 Assets/DoNotLeaveMe/Video/），\n"
