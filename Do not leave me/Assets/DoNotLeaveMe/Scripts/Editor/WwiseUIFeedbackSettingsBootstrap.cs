...
public static class WwiseUIFeedbackSettingsBootstrap
{
    ...
    private const string SettingsFolder = ResourcesFolder + "/DoNotLeaveMe";
    private const string SettingsPath = SettingsFolder + "/WwiseUIFeedbackSettings.asset";
    ...
    [MenuItem("Tools/DoNotLeaveMe/Audio/Refresh Wwise UI Feedback Settings")]
    ...
    private static bool EnsureSettings(bool logSuccess)
    {
        ...
        EnsureFolder(SettingsFolder, "DoNotLeaveMe");
