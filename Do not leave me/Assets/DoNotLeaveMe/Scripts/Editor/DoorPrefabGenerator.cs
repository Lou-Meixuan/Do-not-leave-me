...
public static class DoorPrefabGenerator
{
    private const string OutputFolder = "Assets/DoNotLeaveMe/Levels/Prefabs/Doors";
    ...
    {
        new DoorDefinition { name = "PivotDoor_Door3", meshGuid = "353bc00b702188a4990af49810ce7830", materialGuid = "4e5519b1c95658d4ead5f377390c3843" },
        new DoorDefinition { name = "PivotDoor_MetalGrille", meshGuid = "", materialGuid = "" },
        new DoorDefinition { name = "PivotDoor_BigDoor", meshGuid = "18194154474b9cc47b8f3b7624391376", materialGuid = "d5d453d807bfbc041ad9a9a3e23130a7" }
    };

    [MenuItem("Tools/DoNotLeaveMe/Art/Generate Door Prefab Variants")]
