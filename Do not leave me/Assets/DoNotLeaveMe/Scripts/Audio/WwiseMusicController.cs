...
/// </summary>
[AddComponentMenu("DoNotLeaveMe/Audio/Wwise Music Controller")]
[RequireComponent(typeof(AkAmbient))]
public sealed class WwiseMusicController : MonoBehaviour
{
    [Header("Wwise Events")]
    ...
    [Tooltip("The Wwise Event is named Level5 for design-document compatibility; its runtime scope is Level_04B.")]
    ...
    [SerializeField] private string level5MusicScene = "Level_04B";
    [Min(0f)]
    ...
    private AnxietyState anxietyState;
    ...
    IEnumerator Start()
    {
        ...
        // Persistent initializes all of its Awake methods before Start,
        // but waiting also keeps direct/additive scene testing deterministic.
        while (AnxietyState.Instance == null)
            yield return null;

        anxietyState = AnxietyState.Instance;
    ...
    {
        bool force = false;
        if (anxietyState != AnxietyState.Instance)
        {
            anxietyState = AnxietyState.Instance;
            force = true;
        }
    ...
    bool TryPostStopGameplayMusic()
    {
        ...
        {
            Debug.LogWarning("[WwiseMusicController] Stop_Gameplay_Music is not assigned.", this);
    ...
    void PostGameplayMusic()
    {
        ...
        {
            Debug.LogWarning("[WwiseMusicController] Play_Gameplay_Music is not assigned on AkAmbient.", this);
    ...
    void PostLevel5Music()
    {
        ...
        {
            Debug.LogWarning("[WwiseMusicController] Play_Level5_Music is not assigned.", this);
    ...
    bool TryPostStopLevel5Music()
    {
        ...
        {
            Debug.LogWarning("[WwiseMusicController] Stop_Level5_Music is not assigned.", this);
    ...
    void ApplyRouteMusic()
    {
        ...
        if (shouldUseLevel5Music)
        {
            ...
            PostLevel5Music();
            Debug.Log("[WwiseMusicController] Entered Level_04B; playing Level5 corridor music.", this);
            return;
        }
        ...
        ApplyStates(true);
        PostGameplayMusic();
        Debug.Log("[WwiseMusicController] Left Level_04B; restored gameplay music.", this);
    }
    ...
    static void SetWwiseState(string groupName, string stateName)
    {
        ...
        {
            Debug.LogError("[WwiseMusicController] Wwise State Group and State names cannot be empty.");
            return;
        }
        ...
        {
            Debug.LogWarning(
                "[WwiseMusicController] Failed to set Wwise State " +
