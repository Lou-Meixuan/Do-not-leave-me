...
///
/// 挂载位置：Persistent 场景的 FormalUI Canvas 上（由 UIBuilder 搭建）。
/// 触发方：AnxietyState.HandleFull() 和 MonsterPatrol.TryCatch()。
/// </summary>
[AddComponentMenu("DoNotLeaveMe/Death Screen")]
public class DeathScreen : MonoBehaviour
{
    ...
    public void Show(DeathCause cause)
    {
        ...
        WwiseDeathAudio.PlayDeath(cause == DeathCause.Anxiety);
    ...
    public void Restart()
    {
        ...
        if (flow != null)
            ...
            Debug.LogError("[DeathScreen] 找不到 GameFlowController，重开不了。");
    }
    ...
    public void ReturnToMainMenu()
    {
        ...
        {
            Debug.LogError("[DeathScreen] 场景 \"" + mainMenuSceneName + "\" 不在 Build Settings 里。");
            return;
        }
    ...
    void Hide()
    {
        WwiseDeathAudio.StopDeathAudio();
