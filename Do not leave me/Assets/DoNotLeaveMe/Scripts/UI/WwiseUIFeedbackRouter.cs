...
/// </summary>
[AddComponentMenu("DoNotLeaveMe/Audio/Wwise UI Feedback Router")]
...
public sealed class WwiseUIFeedbackRouter : MonoBehaviour
{
    ...
    private bool TryGetSettings()
    {
        ...
        {
            Debug.LogError(
                "[WwiseUIFeedbackRouter] Missing Resources/DoNotLeaveMe/WwiseUIFeedbackSettings. " +
                "Use Tools > DoNotLeaveMe > Audio > Refresh Wwise UI Feedback Settings in the Unity Editor.");
