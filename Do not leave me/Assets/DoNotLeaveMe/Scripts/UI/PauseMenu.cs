...
/// <summary>
/// 正式关卡的暂停菜单。挂在 Persistent 场景的 FormalUI Canvas 上。
///
...
/// </summary>
[AddComponentMenu("DoNotLeaveMe/Pause Menu")]
public class PauseMenu : MonoBehaviour
{
    ...
    public void RestartLevel()
    {
        ...
        if (flow == null)
        {
            Debug.LogError("[PauseMenu] 找不到 GameFlowController，重开不了。");
            return;
        }
    ...
    public void ReturnToMainMenu()
    {
        ...
        {
            Debug.LogError("[PauseMenu] 场景 \"" + mainMenuSceneName + "\" 不在 Build Settings 里。");
            return;
        }
