...
public class Door : MonoBehaviour, ILevelPermanentState, ILevelActuator
{
    ...
    public event System.Action<Door> StateChanged;
    ...
    /// </summary>
    public static Door FindByNameToken(string nameToken)
    {
