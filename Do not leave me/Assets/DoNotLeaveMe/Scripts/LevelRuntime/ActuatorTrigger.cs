...
// 加上 ILevelPermanentState，这样踏板可以直接当作
// DoorInteraction 的前置条件被引用（它本来就有 IsComplete）
public class ActuatorTrigger : MonoBehaviour, ILevelTemporaryState, ILevelPermanentState
{
    ...
    {
        if (requirement != TriggerRequirement.BothPlayers)
