...
/// 避免修改嵌套 Prefab 资源。目标关卡入口的 LevelEntrySeal 负责双人到达确认。
/// </summary>
[AddComponentMenu("DoNotLeaveMe/Physical Door Exit Binding")]
public class PhysicalDoorExitBinding : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        {
            foreach (ActuatorTrigger trigger in root.GetComponentsInChildren<ActuatorTrigger>(true))
            {
